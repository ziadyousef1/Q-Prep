...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250210205808_intail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Model.Framworks", b =>
                {
                    b.Property<string>("FramworkId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FramworkName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Model.AdvancedLevel", b =>
                {
                    b.HasOne("Core.Model.Framworks", "Framworks")
                        .WithMany()
                        .HasForeignKey("FramworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Framworks");
                });
